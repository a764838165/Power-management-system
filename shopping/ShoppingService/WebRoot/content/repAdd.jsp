...
<script type="text/javascript">
 ...
 function dosubmit(){
   ...
   th.action="<%=path%>/servlet/MessageAction?action_flag=updataMessage&mid=<%=flag %>";
		th.submit();
	}
</script>
							...
							<td bgcolor="#f3ffe3"><table width="99%" border="0"
									...
									<tr>
										...
										<td width="75%" height="50" class="STYLE1"><div
												align="left" class="STYLE2 STYLE1">添加信息</div></td>
