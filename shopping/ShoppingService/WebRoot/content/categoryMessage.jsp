					...
					<tr>
						...
						<td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#54B0E9"
								...
								<tr>
									...
									<td width="15%" height="18" class="STYLE1"><div align="center" class="STYLE2 STYLE1">分类名称</div></td>
								...
								<tr>
									...
									<td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1"><%=map.get("cgName") %></div></td>
									<td height="18" bgcolor="#FFFFFF"><div align="center">
											<span class="STYLE2"> </span><span class="STYLE1">[</span><a href="<%=path%>/servlet/ShopAction?action_flag=deleteCategory&cgId=<%=map.get("cgId") %>">删除</a><span
												class="STYLE1">]</span>
										</div></td>
								</tr>
