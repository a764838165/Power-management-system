			...
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#54B0E9"
								...
								<td width="17%" height="18" class="STYLE1"><div align="center" class="STYLE2 STYLE1">提交时间</div></td>
						
									<td width="8%" height="18" class="STYLE1"><div align="center" class="STYLE2">操作</div></td>
								</tr>
								...
								<tr>
									...
									<td height="18" bgcolor="#FFFFFF" align="center">
										<%
										if(map.get("adminState").equals("1")){
										
										 %>
									
										<div align="center">
											<span class="STYLE2"> </span><span class="STYLE1">[</span><a href="<%=path%>/servlet/RegisterAction?action_flag=queryMsg&uid=<%=map.get("uid") %>">查看</a><span
												class="STYLE1">]</span>
										</div>
