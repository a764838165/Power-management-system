...
<script type="text/javascript">
 function dosubmit(){
   ...
   th.action="<%=path%>/servlet/CourseAction?action_flag=addCourse";
   th.submit();
 }
</script>
			...
			<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#54B0E9"
								...
								<tr>
								<tr>
									<td height="45" bgcolor="#FFFFFF"><div align="center" class="STYLE2 STYLE1">课程名称</div></td>
									<td height="45" bgcolor="#FFFFFF"><div align="left" class="STYLE2 STYLE1">
											<INPUT style="width:350px;height: 40px" class=text2 size=18 name="courseName" minLength="1">
										</div></td>
								</tr>
								<tr>
								...
								<TR>
									<TD bgcolor="#FFFFFF" colspan="2" height="55" align="center" vAlign="middle"><a href="javascript:dosubmit();"><img
											src="images/ok_1.jpg" name="Image3" width="60" height="22" border="0"></a> <a href="javascript:history.back();"><img
											src="images/fh_1.jpg" name="Image4" width="60" height="22" border="0"></a></TD>
