...
<%@ taglib uri="/struts-tags" prefix="s"%>
 <script language="javascript"> 
  function checkchar(){
  	document.Form1.action="system/userAction_home.do";
...
<HTML>
	...
	<body >
		<s:form id="Form1" name="Form1" action="/system/userAction_home.do" method="post" cssStyle="margin:0px;"> 
		...
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				...
				<tr>
					...
					onclick="openWindow('userAction_add.do','700','400');"/>
					</td>
				</tr>
				<tr>
								...
								<s:iterator value="%{#request.userList}" var="user">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td align="center" style="HEIGHT: 22px" align="center" width="10%">																	
										   <a href="#" onclick="openWindow('userAction_edit.do?userID=<s:property value="%{#user.userID}"/>','700','400');">
